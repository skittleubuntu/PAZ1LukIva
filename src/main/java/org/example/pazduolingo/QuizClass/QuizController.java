...
public class QuizController {
    ...
    void initialize() {
        noteQuestionButton.setOnAction(event -> {
            ...
            if (lifes > 0) {
                ...
                lifes --;
                if (lifes > 10000){
                    lifeInfo.setText("Lifes: Infinity");
                }
    ...
    private void showQuiz() {
       ...
       lifeInfo.setText("Lifes: Infinity");
        ...
        questionLabel.setText("Question " + (currentIndex + 1));
    ...
    private void goToNextQuestion() {
        ...
        if (progres >= 100.0) {
            ...
            answersContainer.getChildren().clear();
            noteQuestionButton.setDisable(true
            );
        }
    }
